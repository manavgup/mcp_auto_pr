...
from mcp_local_repo_analyzer.services.change_detector import ChangeDetector
from mcp_local_repo_analyzer.services.client import GitClient
from mcp_local_repo_analyzer.services.status_tracker import StatusTracker
...
class TestStatusTracker:
    ...
    async def test_get_repository_status_basic(self):
        ...
        from mcp_local_repo_analyzer.models.commits import (
            StashedChanges,
            UnpushedCommit,
        )
        ...
        self.change_detector.detect_working_directory_changes = AsyncMock(return_value=mock_working_changes)
        self.change_detector.detect_staged_changes = AsyncMock(return_value=mock_staged_changes)
        self.change_detector.detect_unpushed_commits = AsyncMock(return_value=[mock_unpushed_commit])
        self.change_detector.detect_stashed_changes = AsyncMock(return_value=[mock_stashed_change])
        ...
        result = await self.status_tracker.get_repository_status(self.test_repo, self.mock_ctx)
    ...
    async def test_get_branch_status_basic(self):
        ...
        result = await self.status_tracker.get_branch_status(self.test_repo, self.mock_ctx)
    ...
    async def test_get_health_metrics_basic(self):
        ...
        result = await self.status_tracker.get_health_metrics(self.test_repo, self.mock_ctx)
    ...
    async def test_get_repository_status_with_errors(self):
        ...
        with pytest.raises(Exception, match="Change detector failed"):
            await self.status_tracker.get_repository_status(self.test_repo, self.mock_ctx)
    ...
    async def test_get_branch_status_with_errors(self):
        ...
        self.git_client.get_branch_info = AsyncMock(side_effect=Exception("Git client failed"))
    ...
    async def test_get_health_metrics_with_errors(self):
        ...
        self.status_tracker.get_repository_status = AsyncMock(side_effect=Exception("Repository status failed"))
    ...
    async def test_get_repository_status_partial_failures(self):
        ...
        self.change_detector.detect_staged_changes = AsyncMock(side_effect=Exception("Staged changes failed"))
