...
from mcp_pr_recommender.models.recommendations import ChangeGroup, PRRecommendation
...
class TestSemanticAnalyzer:
    ...
    def mock_settings(self):
        ...
        with patch("mcp_pr_recommender.services.semantic_analyzer.settings") as mock_settings_func:
    ...
    def sample_files(self):
        ...
        return [
            ...
            FileStatus(path="src/utils.py", status_code="M", lines_added=20, lines_deleted=10),
            FileStatus(
            ...
            FileStatus(path="README.md", status_code="M", lines_added=5, lines_deleted=2),
            FileStatus(path="config.yaml", status_code="M", lines_added=3, lines_deleted=1),
        ]
    ...
    async def test_analyzer_initialization(self, mock_settings):
        ...
        with patch("mcp_pr_recommender.services.semantic_analyzer.openai.AsyncOpenAI") as mock_openai:
    ...
    @pytest.mark.asyncio
    async def test_analyze_and_generate_prs_success(self, analyzer, sample_files, sample_analysis):
    ...
    @pytest.mark.asyncio
    async def test_analyze_and_generate_prs_empty_files(self, analyzer, sample_analysis):
    ...
    @pytest.mark.asyncio
    async def test_analyze_and_generate_prs_filtered_files(self, analyzer, sample_analysis):
        ...
        analyzer.client.chat.completions.create = AsyncMock(side_effect=Exception("Test error"))
    ...
    @pytest.mark.asyncio
    async def test_llm_group_files_success(self, analyzer, sample_files, sample_analysis):
    ...
    @pytest.mark.asyncio
    async def test_llm_group_files_none_response(self, analyzer, sample_files, sample_analysis):
    ...
    @pytest.mark.asyncio
    async def test_llm_group_files_exception(self, analyzer, sample_files, sample_analysis):
    ...
    def test_create_grouping_prompt_with_no_changes(self, analyzer, sample_analysis):
        ...
        files = [
            FileStatus(path="file1.py", status_code="M", lines_added=10, lines_deleted=5),
            FileStatus(path="file2.py", status_code="M", lines_added=0, lines_deleted=0),
        ]
    ...
    def test_fallback_grouping_with_changes(self, analyzer):
        ...
        files = [
            ...
            FileStatus(path="pyproject.toml", status_code="M", lines_added=2, lines_deleted=1),
            FileStatus(path="docs/guide.md", status_code="M", lines_added=5, lines_deleted=2),
        ]
    ...
    def test_fallback_grouping_without_changes(self, analyzer):
        ...
        files = [
            FileStatus(path="file1.py", status_code="M", lines_added=0, lines_deleted=0),
            FileStatus(path="file2.py", status_code="M", lines_added=0, lines_deleted=0),
        ]
    ...
    def test_fallback_grouping_mixed(self, analyzer):
        ...
        files = [
            ...
            FileStatus(path="Main.java", status_code="A", lines_added=100, lines_deleted=0),
            FileStatus(path="server.go", status_code="M", lines_added=20, lines_deleted=10),
            FileStatus(path="requirements.txt", status_code="M", lines_added=2, lines_deleted=1),
        ]
    ...
    def test_generate_title_source_code(self, analyzer):
        ...
        group = ChangeGroup(
            ...
            files=[FileStatus(path="src/main.py", status_code="M", lines_added=10, lines_deleted=5)],
            category="feature",
            confidence=0.9,
            reasoning="Test",
    ...
    def test_generate_title_cleanup(self, analyzer):
        ...
        group = ChangeGroup(
            ...
            files=[FileStatus(path="file.py", status_code="M", lines_added=0, lines_deleted=0)],
            category="chore",
            confidence=0.5,
            reasoning="Test",
            semantic_similarity=0.8,
    ...
    def test_generate_title_custom(self, analyzer):
        ...
        group = ChangeGroup(
            ...
            files=[FileStatus(path="auth.py", status_code="M", lines_added=10, lines_deleted=5)],
            category="feature",
            confidence=0.9,
            reasoning="Test",
            semantic_similarity=0.8,
    ...
    def test_generate_description(self, analyzer):
        ...
        group = ChangeGroup(
            ...
            files=[
                FileStatus(path="file1.py", status_code="M", lines_added=10, lines_deleted=5),
                FileStatus(path="file2.py", status_code="A", lines_added=20, lines_deleted=0),
                FileStatus(path="file3.py", status_code="M", lines_added=0, lines_deleted=0),
            ],
            category="feature",
            confidence=0.9,
    ...
    def test_determine_priority(self, analyzer):
        ...
        group = ChangeGroup(
            id="test",
            files=[FileStatus(path="file.py", status_code="M", lines_added=10, lines_deleted=5)],
            category="feature",
            confidence=0.9,
            reasoning="Test",
            semantic_similarity=0.8,
    ...
    def test_generate_labels(self, analyzer):
        ...
        # Test cleanup label
        group.files = [FileStatus(path="file.py", status_code="M", lines_added=0, lines_deleted=0)]
        labels = analyzer._generate_labels(group)
        assert "cleanup" in labels

    @pytest.mark.asyncio
    async def test_analyze_and_generate_prs_integration(self, analyzer, sample_analysis):
        """Test full integration of analyze_and_generate_prs."""
        files = [
            FileStatus(path="src/main.py", status_code="M", lines_added=100, lines_deleted=50),
            FileStatus(path="src/utils.py", status_code="M", lines_added=20, lines_deleted=10),
            FileStatus(
                path="tests/test_main.py",
                status_code="A",
            ...
            FileStatus(path="__pycache__/cache.pyc", status_code="A"),  # Should be filtered
            FileStatus(path="config.yaml", status_code="M", lines_added=5, lines_deleted=2),
            FileStatus(path="README.md", status_code="M", lines_added=10, lines_deleted=5),
        ]
        ...
        recommendations = await analyzer.analyze_and_generate_prs(files, sample_analysis)
