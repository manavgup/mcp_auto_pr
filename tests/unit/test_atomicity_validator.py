...
class TestAtomicityValidator:
    ...
    def mock_settings(self):
        ...
        with patch("mcp_pr_recommender.services.atomicity_validator.get_pr_recommender_settings") as mock_settings_func:
    ...
    def large_group(self):
        ...
        files = [
            FileStatus(path=f"src/file_{i}.py", status_code="M", lines_added=5, lines_deleted=2)
    ...
    def test_validate_and_split_atomic_groups(self, validator, atomic_group, mock_settings):
    ...
    def test_validate_and_split_large_group(self, validator, large_group, mock_settings):
    ...
    def test_validate_and_split_mixed_concerns(self, validator, mixed_concerns_group, mock_settings):
    ...
    def test_is_atomic_too_many_changes(self, validator, mock_settings):
        ...
        files = [FileStatus(path="huge_file.py", status_code="M", lines_added=800, lines_deleted=500)]
        group = ChangeGroup(
            id="huge_changes",
            files=files,
            category="source",
    ...
    def test_is_atomic_mixed_concerns(self, validator, mixed_concerns_group, mock_settings):
    ...
    def test_split_group_by_concern(self, validator, mixed_concerns_group, mock_settings):
    ...
    def test_split_by_size_exact_chunks(self, validator, mock_settings):
        ...
        for i, split_group in enumerate(split_groups):
            ...
            assert abs(split_group.confidence - 0.72) < 0.0001  # 0.9 * 0.8 with float tolerance
    ...
    def test_split_group_preserves_metadata(self, validator, large_group, mock_settings):
